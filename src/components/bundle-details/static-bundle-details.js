...
import BundleDetails from '@custom-applications-local/bundles-core/components/bundle-details';
import { TabHeader } from '@custom-applications-local/core/components';
